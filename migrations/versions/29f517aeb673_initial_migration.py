...
def upgrade():
    ...
    sa.Column('role', sa.Enum('super_admin', 'admin_divisi', 'admin_ruangan', name='user_role', native_enum=False, length=50), nullable=False),
    ...
    sa.Column('condition', sa.Enum('baik', 'perlu_perhatian', 'kritis', 'tidak_layak', name='asset_condition', native_enum=False, length=50), nullable=False),
    sa.Column('status', sa.Enum('aktif', 'dalam_perbaikan', 'tidak_aktif', 'menunggu_approval', name='asset_status', native_enum=False, length=50), nullable=False),
    ...
    sa.Column('approval_status', sa.Enum('pending', 'approved', 'rejected', name='approval_status', native_enum=False, length=50), nullable=False),
    ...
    sa.Column('risk_category', sa.Enum('rendah', 'sedang', 'tinggi', name='risk_category', native_enum=False, length=50), nullable=False),
    ...
    sa.Column('action_type', sa.Enum('evaluasi_fmea', 'perbaikan', 'penggantian', 'pemeriksaan_rutin', 'approval_disetujui', 'approval_ditolak', 'pengajuan_status', 'cetak_kir', name='maintenance_action_type', native_enum=False, length=50), nullable=False),
    ...
    sa.Column('type', sa.Enum('rpn_tinggi', 'rpn_sedang', 'approval_baru', 'approval_disetujui', 'approval_ditolak', 'maintenance_terlambat', name='notification_type', native_enum=False, length=50), nullable=False),
