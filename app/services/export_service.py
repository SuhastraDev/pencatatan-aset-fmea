...
def generate_excel(asset_data, room_name, room_code):
    ...
    # Header
    headers = [
        'No', 'Kode Barang', 'Nama Aset', 'Kondisi Aset', 'Hasil RPN',
        'Kategori RPN', 'Tanggal Evaluasi', 'Catatan Hasil Tindakan',
        'Rekomendasi AI'
    ]
    ws.append(headers)
...
def generate_excel_divisi(asset_data, room_stats):
    ...
    headers = ['No', 'Kode Barang', 'Nama Aset', 'Ruangan', 'Kondisi Aset',
               'Hasil RPN', 'Kategori RPN', 'Tgl Evaluasi',
               'Catatan Hasil Tindakan', 'Rekomendasi AI']
    ws1.append(headers)
